        ...
        <nav class="templatemo-left-nav">
            <ul>
                <li><a href="${pageContext.request.contextPath}/user/manager"><i class="fa fa-users fa-fw"></i>Manage
                    Books</a></li>
                <li><a href="${pageContext.request.contextPath}/user/addBookInfo" class="active"><i
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget white-bg">
                <h2 class="margin-bottom-10">添加图书</h2>

                <%-- <c:if test="${message}">
                     return showMessage();
                 </c:if>--%>

                <form action="addBookInfo" class="templatemo-login-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12 form-group">
                            ...
                            <textarea class="form-control" name="describeX" rows="3"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group text-right">
                        <button class="templatemo-blue-button" value="book" onClick="return fun()">Add
                        </button>
