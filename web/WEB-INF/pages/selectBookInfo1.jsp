...
<div class="templatemo-flex-row">
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                <li><a href="${pageContext.request.contextPath}/user/member" ><i class="fa fa-users fa-fw"></i>Show Books</a></li>
                <li><a href="${pageContext.request.contextPath}/user/selectBookInfo1" class="active"><i class="fa fa-database fa-fw"></i>SELECT BOOKS</a></li>
            </ul>
        </nav>
    </div>
    <!-- Main content -->
