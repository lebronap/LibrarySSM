            ...
            <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <c:forEach items="${books}" var="book">
                    ...
                    <tr>
                        ...
                        <td>${book.address}</td>
                        <td>${book.typeX}</td>
                        <td><a href="${pageContext.request.contextPath}/user/updateBookInfo"
                               class="templatemo-edit-btn">Edit</a></td>
                        <td><a href="${pageContext.request.contextPath}/user/deleteBookInfo" class="templatemo-link">Delete</a></td>
                    </tr>
